...
public class MainActivityTest {
    ...
    public void testActivitySwitch() {
        ...
        // Check if ShowActivity is displayed by checking for a view in its layout
    ...
    public void testCityNameConsistency() {
        ...
        // Check if the correct city name is displayed
        onView(withId(R.id.textView_cityName)).check(matches(withText("Saskatoon")));
    }
    ...
    public void testBackButton() {
        // Add a city
        onView(withId(R.id.button_add)).perform(click());
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Winnipeg"));
        onView(withId(R.id.button_confirm)).perform(click());
